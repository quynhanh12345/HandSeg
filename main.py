...
def get_args():
    ...
    parser.add_argument('--epochs', type=int, default=10, help='The number of epochs used for the training.')
    ...
    parser.add_argument('--data_base_path', default='./data', type=str, help='The path of the input dataset.')
